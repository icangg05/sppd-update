...
@section('content')
    ...
    <button onclick="window.history.back()" class="inline-flex items-center gap-2 rounded bg-slate-800 px-6 py-3 text-sm font-bold text-white shadow-lg shadow-slate-800/30 transition-all hover:-translate-y-1 hover:bg-slate-900 hover:shadow-xl">
