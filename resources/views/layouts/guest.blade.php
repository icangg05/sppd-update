...
<body class="min-h-screen bg-sky-950 font-sans text-slate-900" style="font-family: 'Poppins', sans-serif;">
	<div class="relative min-h-screen overflow-hidden px-4 py-5 sm:px-6 lg:px-8">
		...
		<div
			class="pointer-events-none absolute left-1/3 top-1/2 h-16 w-16 animate-[pulseGlow_8s_ease-in-out_infinite] rounded-full bg-sky-200/20 blur-2xl">
		</div>
		<div
			class="pointer-events-none absolute right-1/4 top-1/4 h-12 w-12 animate-[float_7s_ease-in-out_infinite] rounded-full border border-sky-100/20 bg-sky-100/10">
		</div>
