	...
	<div class="rounded border border-slate-200 bg-white p-4 shadow-sm">
		<div class="flex flex-col sm:flex-row gap-3">
			...
			<x-ui.button wire:click="resetFilters" type="button" variant="secondary" :disabled="! $hasFilter"
				class="rounded px-4 py-2 font-semibold text-slate-600 whitespace-nowrap disabled:opacity-50 disabled:cursor-not-allowed">
							...
							<td class="py-3.5 px-4 text-center">
								<div class="flex items-center justify-center gap-1">
									...
									<a wire:navigate href="{{ route('master.budgets.show', $budget->id) }}"
										class="rounded border border-slate-200 bg-white p-1.5 text-slate-500 hover:bg-primary-50 hover:text-primary-600 transition-colors"
									...
									@can('budget.edit')
										<a wire:navigate href="{{ route('master.budgets.edit', $budget->id) }}"
											class="rounded border border-slate-200 bg-white p-1.5 text-slate-500 hover:bg-amber-50 hover:text-amber-600 transition-colors"
											title="Edit Anggaran">
									...
									@can('budget.delete')
										<button type="button" wire:click="confirmDelete({{ $budget->id }})"
											class="rounded border border-slate-200 bg-white p-1.5 text-slate-500 hover:bg-rose-50 hover:text-rose-600 transition-colors"
