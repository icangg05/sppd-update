<div class="p-1 space-y-4">
  ...
  <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-200 pb-3">
    <div class="flex items-center gap-2.5">
      ...
      <div>
        <h1 class="text-base font-bold text-slate-800 uppercase tracking-wide">Kelola Data Jabatan</h1>
        <p class="text-[11px] text-slate-500 font-medium">
          Tambah, ubah, dan hapus master jabatan beserta cakupan keunikannya
        </p>
      </div>
    </div>
    ...
    <div class="flex flex-col sm:flex-row items-center gap-2">
      ...
      <div class="w-full sm:w-56">
        <x-form.searchable-select wire:model.live="scopeFilter" name="scopeFilter" :options="$scopeOptions"
          placeholder="Semua Cakupan" searchPlaceholder="Cari cakupan..." class="bg-slate-50 py-1.5 text-xs" />
      </div>
