...
<div class="contents" x-data="{ shake: false }"
	...
	">
	{{-- Teleport ke body agar z-index modal bersaing global, tidak terjebak di
	     stacking context <main> (sidebar/header/card punya konteks sendiri). --}}
	<template x-teleport="body">
		<div x-show="{{ $show }}" class="fixed inset-0 z-60 overflow-y-auto" style="display: none;">
			<!-- Backdrop -->
			<div x-show="{{ $show }}"
