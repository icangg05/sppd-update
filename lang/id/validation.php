...
return [
  ...
  | kelas validator. Beberapa aturan memiliki versi ganda seperti aturan
  ...
  */
  ...
  'lte' => [
    ...
    'numeric' => 'Kolom :attribute harus bernilai lebih kecil dari atau sama dengan :value.',
  ...
  'string' => 'Kolom :attribute harus berupa untaian (string).',
  ...
  | konvensi "attribute.rule" untuk menamai barisnya. Hal ini mempermudah
  ...
  */
  ...
  | sesuatu yang lebih ramah pembaca seperti "Alamat Surel" alih-alih
  | "email". Hal ini membantu membuat pesan menjadi lebih ekspresif.
  |
  */
