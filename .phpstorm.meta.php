...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'database.connections.mysql_old.driver' => 'string',
            'database.connections.mysql_old.host' => 'string',
            'database.connections.mysql_old.port' => 'string',
            'database.connections.mysql_old.database' => 'string',
            'database.connections.mysql_old.username' => 'string',
            'database.connections.mysql_old.password' => 'string',
            'database.connections.mysql_old.charset' => 'string',
            'database.connections.mysql_old.collation' => 'string',
            'database.connections.mysql_old.prefix' => 'string',
            'database.connections.mysql_old.strict' => 'boolean',
            ...
            'kirimchat.base_url' => 'string',
            'kirimchat.api_key' => 'string',
            'kirimchat.enabled' => 'boolean',
            'kirimchat.verification_number' => 'string',
            'kirimchat.webhook_secret' => 'NULL',
            'kirimchat.keepalive.enabled' => 'boolean',
            'kirimchat.keepalive.phone' => 'string',
            'kirimchat.keepalive.frequency' => 'string',
            'kirimchat.keepalive.time' => 'string',
            'kirimchat.keepalive.message' => 'string',
            ...
            'queue_health.enabled' => 'boolean',
            'queue_health.max_staleness_seconds' => 'integer',
            'role_uniqueness.system' => 'array',
            'role_uniqueness.department' => 'array',
            ...
            'sppd.default_province_name' => 'string',
            'sppd.home_base_regency_keyword' => 'string',
            'tte.default_provider' => 'string',
            'tte.providers.local_proxy.name' => 'string',
            'tte.providers.local_proxy.driver' => 'string',
            'tte.providers.local_proxy.endpoint' => 'string',
            'tte.providers.local_proxy.basic_auth' => 'string',
            'tte.providers.local_proxy.timeout' => 'string',
            'tte.providers.bssn.name' => 'string',
            'tte.providers.bssn.driver' => 'string',
            'tte.providers.bssn.endpoint' => 'string',
            'tte.providers.bssn.client_id' => 'NULL',
            'tte.providers.bssn.client_secret' => 'NULL',
            'tte.providers.bssn.timeout' => 'string',
            'tte.storage.disk' => 'string',
            'tte.storage.paths.draft' => 'string',
            'tte.storage.paths.signed' => 'string',
            'tte.storage.paths.signatures' => 'string',
            'tte.storage.paths.qr_codes' => 'string',
            'tte.queue.connection' => 'string',
            'tte.queue.driver' => 'string',
            'tte.queue.retry_attempts' => 'string',
            'tte.queue.retry_delay' => 'string',
            'tte.pdf.format' => 'string',
            'tte.pdf.margin_top' => 'integer',
            'tte.pdf.margin_bottom' => 'integer',
            'tte.pdf.margin_left' => 'integer',
            'tte.pdf.margin_right' => 'integer',
            'tte.pdf.font_size' => 'integer',
            'tte.pdf.font_family' => 'string',
            'tte.signature.qr_code_enabled' => 'boolean',
            'tte.signature.qr_code_size' => 'integer',
            'tte.signature.signature_box_width' => 'integer',
            'tte.signature.signature_box_height' => 'integer',
            'tte.signature.visible_signature' => 'boolean',
            'tte.logging.enabled' => 'boolean',
            'tte.logging.channel' => 'string',
            'tte.logging.level' => 'string',
            'users.default_password' => 'string',
...
'app.aliases.View','app.aliases.Vite','app.sppd_version','auth.defaults.guard','auth.defaults.passwords',
...
'database.connections.mysql_old.driver','database.connections.mysql_old.host','database.connections.mysql_old.port','database.connections.mysql_old.database','database.connections.mysql_old.username',
'database.connections.mysql_old.password','database.connections.mysql_old.charset','database.connections.mysql_old.collation','database.connections.mysql_old.prefix','database.connections.mysql_old.strict',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./app/public/storage','fonnte.url',
'fonnte.token','fonnte.enabled','hashids.default','hashids.connections.main.salt','hashids.connections.main.length',
'hashids.connections.alternative.salt','hashids.connections.alternative.length','kirimchat.base_url','kirimchat.api_key','kirimchat.enabled',
'kirimchat.verification_number','kirimchat.webhook_secret','kirimchat.keepalive.enabled','kirimchat.keepalive.phone','kirimchat.keepalive.frequency',
'kirimchat.keepalive.time','kirimchat.keepalive.message','livewire.component_locations','livewire.component_namespaces.layouts','livewire.component_namespaces.pages',
...
'logging.channels.browser.driver','logging.channels.browser.path','logging.channels.browser.level','logging.channels.browser.days','logging.channels.deprecations.driver',
...
'queue_health.enabled','queue_health.max_staleness_seconds','role_uniqueness.system','role_uniqueness.department','services.postmark.key',
...
'session.same_site','session.partitioned','session.serialization','sppd.default_province_name','sppd.home_base_regency_keyword',
'tte.default_provider','tte.providers.local_proxy.name','tte.providers.local_proxy.driver','tte.providers.local_proxy.endpoint','tte.providers.local_proxy.basic_auth',
'tte.providers.local_proxy.timeout','tte.providers.bssn.name','tte.providers.bssn.driver','tte.providers.bssn.endpoint','tte.providers.bssn.client_id',
'tte.providers.bssn.client_secret','tte.providers.bssn.timeout','tte.storage.disk','tte.storage.paths.draft','tte.storage.paths.signed',
'tte.storage.paths.signatures','tte.storage.paths.qr_codes','tte.queue.connection','tte.queue.driver','tte.queue.retry_attempts',
'tte.queue.retry_delay','tte.pdf.format','tte.pdf.margin_top','tte.pdf.margin_bottom','tte.pdf.margin_left',
'tte.pdf.margin_right','tte.pdf.font_size','tte.pdf.font_family','tte.signature.qr_code_enabled','tte.signature.qr_code_size',
'tte.signature.signature_box_width','tte.signature.signature_box_height','tte.signature.visible_signature','tte.logging.enabled','tte.logging.channel',
'tte.logging.level','users.default_password','dompdf.show_warnings','dompdf.public_path','dompdf.convert_entities',
...
'mcp.redirect_domains','mcp.custom_schemes','mcp.authorization_server','activitylog.enabled','activitylog.clean_after_days',
'activitylog.default_log_name','activitylog.default_auth_driver','activitylog.include_soft_deleted_subjects','activitylog.activity_model','activitylog.default_except_attributes',
'activitylog.buffer.enabled','activitylog.actions.log_activity','activitylog.actions.clean_log','ide-helper.filename','ide-helper.models_filename',
...
'livewire.upload-file','livewire.preview-file','login','logout','dashboard',
'sppd.index','sppd.create','sppd.create.details','sppd.calendar','sppd.show',
'sppd.destroy','sppd.next','sppd.manage-sppd','sppd.manage-spt','sppd.receipts',
'sppd.actual-expenses','sppd.final-costs','sppd.report-input','sppd.cost-details.store','sppd.cost-details.update',
'sppd.cost-details.destroy','sppd.actual-expenses.store','sppd.actual-expenses.update','sppd.actual-expenses.destroy','sppd.advance-receipts.store',
'sppd.update-pptk','sppd.report.store','sppd.sign.batch-status','sppd.sign.status','sppd.sign.download',
'sppd.stream.spt','sppd.stream.sppd','sppd.stream.kuitansi-rampung','sppd.stream.kuitansi-panjar','sppd.stream.pengeluaran-riil',
'sppd.stream.rincian-biaya','workflows.preview','master.users.index','master.users.create','master.users.show',
'master.users.edit','master.departments.index','master.departments.create','master.departments.show','master.departments.edit',
'master.departments.destroy','master.position-requests.index','master.budgets.index','master.budgets.create','master.budgets.store',
'master.budgets.show','master.budgets.edit','master.budgets.update','master.budgets.destroy','master.workflows.index',
'master.workflows.create','master.workflows.store','master.workflows.edit','master.workflows.update','master.workflows.destroy',
'master.roles.index','master.roles.create','master.roles.edit','master.roles.destroy','api.regencies',
'api.sppd.workflow-preview','system.health.ping','system.health','webhook.kirimchat','storage.local',
'storage.local.upload',);
        registerArgumentsSet('views', 
'9b23354fcca061072431135060492f08::dashboard.dpa-summary','9b23354fcca061072431135060492f08::form.checkbox','9b23354fcca061072431135060492f08::form.file','9b23354fcca061072431135060492f08::form.input','9b23354fcca061072431135060492f08::form.radio',
'9b23354fcca061072431135060492f08::form.searchable-select','9b23354fcca061072431135060492f08::form.select','9b23354fcca061072431135060492f08::form.textarea','9b23354fcca061072431135060492f08::header','9b23354fcca061072431135060492f08::sidebar',
'9b23354fcca061072431135060492f08::ui.badge','9b23354fcca061072431135060492f08::ui.budget-bar','9b23354fcca061072431135060492f08::ui.button','9b23354fcca061072431135060492f08::ui.modal','auth.login',
'budgets.budget-index','budgets.create','budgets.edit','budgets.show','c0c9f1492644ec6b448d31de08110d38::budgets.budget-index',
'c0c9f1492644ec6b448d31de08110d38::dashboard.dpa-panel','c0c9f1492644ec6b448d31de08110d38::departments.form','c0c9f1492644ec6b448d31de08110d38::departments.index','c0c9f1492644ec6b448d31de08110d38::pending-approval-badge','c0c9f1492644ec6b448d31de08110d38::pending-position-request-badge',
'c0c9f1492644ec6b448d31de08110d38::position-requests.index','c0c9f1492644ec6b448d31de08110d38::role-form','c0c9f1492644ec6b448d31de08110d38::sppd.create','c0c9f1492644ec6b448d31de08110d38::sppd.create-details','c0c9f1492644ec6b448d31de08110d38::sppd.index',
'c0c9f1492644ec6b448d31de08110d38::sppd.partials.tte-row','c0c9f1492644ec6b448d31de08110d38::sppd.show','c0c9f1492644ec6b448d31de08110d38::sppd.sppd-calendar','c0c9f1492644ec6b448d31de08110d38::user-form','c0c9f1492644ec6b448d31de08110d38::users-index',
'components.dashboard.dpa-summary','components.form.checkbox','components.form.file','components.form.input','components.form.radio',
'components.form.searchable-select','components.form.select','components.form.textarea','components.header','components.sidebar',
'components.ui.badge','components.ui.budget-bar','components.ui.button','components.ui.modal','dashboard',
'dashboard.dpa-panel','dashboard.dpa-summary','dashboard.partials._recent-sppd','dashboard.partials.admin','dashboard.partials.leadership',
'dashboard.partials.requester','departments.form','departments.index','errors.403','errors.404',
'errors.500','errors.503','errors.layout','exports.kuitansi_rampung','exports.pengeluaran_riil',
'exports.rincian_biaya','exports.sppd','exports.spt','exports.spt_dprd','f4ac99e09542ff494432bc959d4fee61::app',
'f4ac99e09542ff494432bc959d4fee61::guest','form.checkbox','form.file','form.input','form.radio',
'form.searchable-select','form.select','form.textarea','header','layouts.app',
'layouts.guest','layouts::app','layouts::guest','livewire.budgets.budget-index','livewire.dashboard.dpa-panel',
'livewire.departments.form','livewire.departments.index','livewire.pending-approval-badge','livewire.pending-position-request-badge','livewire.position-requests.index',
'livewire.role-form','livewire.sppd.create','livewire.sppd.create-details','livewire.sppd.index','livewire.sppd.partials.tte-row',
'livewire.sppd.show','livewire.sppd.sppd-calendar','livewire.user-form','livewire.users-index','livewire::bootstrap',
'livewire::simple-bootstrap','livewire::simple-tailwind','livewire::tailwind','master.departments.show','master.roles.create',
'master.roles.edit','master.roles.index','master.users.create','master.users.edit','master.users.show',
'master.workflows.create','master.workflows.edit','master.workflows.index','pagination::bootstrap-3','pagination::bootstrap-4',
...
'pagination::simple-tailwind','pagination::tailwind','pending-approval-badge','pending-position-request-badge','position-requests.index',
'role-form','sidebar','sppd.costs.actuals','sppd.costs.final_details','sppd.costs.receipts',
'sppd.create','sppd.create-details','sppd.index','sppd.manage_sppd','sppd.manage_spt',
'sppd.next','sppd.partials.tte-row','sppd.report_input','sppd.show','sppd.sppd-calendar',
'ui.badge','ui.budget-bar','ui.button','ui.modal','user-form',
...
'vendor.pagination.bootstrap-3','vendor.pagination.bootstrap-4','vendor.pagination.bootstrap-5','vendor.pagination.semantic-ui','vendor.pagination.simple-bootstrap-3',
'vendor.pagination.simple-bootstrap-4','vendor.pagination.simple-bootstrap-5','vendor.pagination.simple-tailwind','vendor.pagination.tailwind','workflows.preview',
...
'validation.custom.attribute-name.rule-name','validation.attributes.name','validation.attributes.nama','validation.attributes.username','validation.attributes.email',
'validation.attributes.password','validation.attributes.password_confirmation','validation.attributes.current_password','validation.attributes.nip','validation.attributes.phone',
'validation.attributes.phone_number','validation.attributes.no_hp','validation.attributes.address','validation.attributes.alamat','validation.attributes.date',
'validation.attributes.tanggal','validation.attributes.start_date','validation.attributes.end_date','validation.attributes.tanggal_mulai','validation.attributes.tanggal_selesai',
'validation.attributes.amount','validation.attributes.jumlah','validation.attributes.description','validation.attributes.keterangan','validation.attributes.department_id',
'validation.attributes.position_id','validation.attributes.role','validation.attributes.title','validation.attributes.file','validation.attributes.document',);
        registerArgumentsSet('env', 
'APP_NAME','APP_ENV','APP_KEY','APP_DEBUG','APP_URL',
'VITE_TUNNEL_URL','APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE','APP_MAINTENANCE_DRIVER',
...
'SESSION_DOMAIN','BROADCAST_CONNECTION','FILESYSTEM_DISK','QUEUE_CONNECTION','QUEUE_HEALTH_ENABLED',
'QUEUE_HEALTH_MAX_STALENESS','E_SIGN_PROVIDER','E_SIGN_API_ENDPOINT','E_SIGN_AUTH_BASIC','E_SIGN_TIMEOUT',
'PDF_STORAGE_DISK','TTE_RETRY_ATTEMPTS','TTE_RETRY_DELAY','TTE_QR_CODE_ENABLED','TTE_LOGGING_ENABLED',
'TTE_LOG_LEVEL','CACHE_STORE','MEMCACHED_HOST','REDIS_CLIENT','REDIS_HOST',
...
'VITE_APP_NAME','KIRIMCHAT_BASE_URL','KIRIMCHAT_API_KEY','KIRIMCHAT_ENABLED','KIRIMCHAT_VERIFICATION_NUMBER',
'KEEPALIVE_ENABLED','KEEPALIVE_PHONE','KEEPALIVE_FREQUENCY','KEEPALIVE_TIME','KEEPALIVE_MESSAGE',);
